(function (global, factory) {
  ...
  function publishMessageValid(message) {
    return messageValid(message) && message.type === 'PUBLISH' && message.topic && message.target;
  }
  /**
  ...
  function hubMessageValid(message) {
    return messageValid(message) && !message.viaHub && ['CONNECT', 'PUBLISH', 'PONG'].includes(message.type);
  }
  /**
  ...
  function app() {
    ...
    function eventHandler(event) {
      ...
      switch (message.type) {
        case 'PUBLISH':
          debug('%o (%o) from %o - %O', message.type, message.topic, message.source, message);
