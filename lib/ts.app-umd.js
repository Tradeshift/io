(function (global, factory) {
  ...
  function appMessageValid(message) {
    return messageValid(message) && message.viaHub && ['CONNACK', 'PUBLISH', 'PINGRES'].includes(message.type);
  }
  /**
  ...
  function hubMessageValid(message) {
    return messageValid(message) && !message.viaHub && ['CONNECT', 'PUBLISH', 'PINGREQ'].includes(message.type);
  }
  /**
  ...
  function app() {
    ...
    function eventHandler(event) {
      ...
      debug('%o (%o) from %o - %O', message.type, message.topic, message.source, message); // Call the matching handlers for the message topic.
