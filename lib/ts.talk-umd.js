(function (global, factory) {
  ...
  (global.ts = global.ts || {}, global.ts.talk = factory());
  ...
  function debugEnabled(namespace) {
    ...
    try {
      ...
      /* DATA_CLONE_ERR */
          ...
          console.warn('ts.talk error while setting up debug logging. You should ignore this message or set %o while sandboxing your iframe. %O', 'allow-same-origin', error);
        } else {
  ...
  function postMessage(message, targetWindow) {
    ...
    try {
      ...
      /* DATA_CLONE_ERR */
          ...
          throw new Error("ts.talk.publish called with { data } argument that can't be cloned using the structural clone algorithm.");
        } else {
...
//# sourceMappingURL=ts.talk-umd.js.map
