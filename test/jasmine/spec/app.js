(function (global, factory) {
	...
	var forwardMessage = function forwardMessage(msg) {
	...
	function () {
	  ...
	  regenerator.mark(function _callee(event) {
	    var message, err, data, _ref2, _ref3;
	    ...
	    return regenerator.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 3:
	            _context.t0 = message.command;
	            _context.next = _context.t0 === 'emit' ? 6 : _context.t0 === 'call' ? 8 : _context.t0 === 'destroy' ? 23 : 25;
	            break;
	          ...
	          case 8:
	            ...
	            _context.prev = 9;
	            _context.next = 12;
	            return app.call(message.method, message.target, message.data);
	...
	app.add('spawn', function (data, submit, parent) {
	  forwardMessage({
	    method: 'spawn',
	    data: data,
	    submit: submit,
